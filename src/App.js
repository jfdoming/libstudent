...
import { calculateDesired, calculateExpected } from "./utils/analytics";
...
const Analytics = ({ assessments, gradingSchemeEntries }) => {
  const percentCurrent = useMemo(
    () => calculateExpected(null, assessments, gradingSchemeEntries),
    [assessments, gradingSchemeEntries]
  );
